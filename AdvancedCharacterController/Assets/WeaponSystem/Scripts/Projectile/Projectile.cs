...
namespace Advanced_Weapon_System {
	...
	public class Projectile : MonoBehaviour {
		public ProjectileSettingsData projectileSettings;
		public Rigidbody rb;
		...
		public float delayedDestruction = 0;
		public bool hasBouncingComponent = false;
		...
		public void AddBehaviours(ProjectileSettings settings) {
			Init();
			projectileSettings = new ProjectileSettingsData(settings);
